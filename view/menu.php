...
<html lang="en">
  <head>
    ...
    <link href="../css/headers.css?v=<?php echo time(); ?>" rel="stylesheet">
  </head>
  <body>
      ...
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
       ...
       <img src="../files/sources/imatges/titol.gif"width="60" height="60">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="../view/hallfame.php" class="nav-link px-2 link-dark"><?php echo $traduccions["Salón de la Fama"] ?></a></li>
